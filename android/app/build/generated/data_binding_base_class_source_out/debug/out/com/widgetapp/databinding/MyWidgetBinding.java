...
public final class MyWidgetBinding implements ViewBinding {
  ...
  private MyWidgetBinding(@NonNull RelativeLayout rootView, @NonNull TextView AppName,
  ...
  public static MyWidgetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MyWidgetBinding((RelativeLayout) rootView, AppName, PlayButton, top1Mode,
